...
console.log("getPage() with right parameters");
console.log(adCollection.getPage(10, 20));
console.log("getPage() with wrong parameters");
console.log(adCollection.getPage(50, 30));
console.log("getPage() with hash tag filter")
console.log(adCollection.getPage(2 , 5, {hashTags: ["Еда"]}));
console.log("getPage() with vendor filter")
console.log(adCollection.getPage(0 , 10, {vendors: ["Штолле", "BURO"]}));
...
console.log("false add()"); // already exists
console.log(adCollection.add({
    id: "13",
    description: "Безлимитный абонемент на месяц всего за 42,50 руб. в тренажерном зале \"Адреналин\"",
    createdAt: new Date("2020-02-02T23:00:00"),
...
console.log("false add()"); // wrong validation (wrong id)
console.log(adCollection.add({
    id: "dcsd", //wrong id
    description: "Скидка на стулья - до 15%",
    createdAt: new Date("2021-03-15T23:00:00"),
...
console.log(adCollection.edit("1", {discount: "100%"}));
console.log("false edit()"); //wrong id
console.log(adCollection.edit("100", {discount: "100%"}));
console.log("false edit()"); //forbidden key vendor
console.log(adCollection.edit("1", {vendor: "Alibaba"}));
console.log("false edit()"); //forbidden key createdAd
console.log(adCollection.edit("1", {createdAt: "021-06-01T23:00:00"}));
console.log("true edit()");
console.log(adCollection.edit("10", {discount: "100%", photoLink: "photo.com"}));
...
console.log(adCollection.remove("100")); // wrong index
